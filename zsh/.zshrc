...
export ANTHROPIC_AUTH_TOKEN="* Insert your DeepSeek API here"
...
# Paths & globbing (blue)
ZSH_HIGHLIGHT_STYLES[path]='fg=#458588,underline'
ZSH_HIGHLIGHT_STYLES[path_prefix]='fg=#458588,underline'
ZSH_HIGHLIGHT_STYLES[globbing]='fg=#458588'
