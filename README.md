...
cd ~/.config/fish
```
Paste the content at the fish folder. This overwrites the themes from the fish_config command and acts
as the global environment for the configs

## Fastfetch
Browse to fastfetch folder
 ```
 cd ~/.config/fastfetch
 ```
